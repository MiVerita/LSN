...
int main (int argc, char *argv[]){
   ...
   //set a large number of throws and a number of simulation block
   int ndata = 1000000;
   ...
   // generate invoca la lambda n volte, assegnandone il risultato agli elementi del vettore
   ...
   vector<int>occurencies(100);
   vector<double>local_chi;
   fill(occurencies.begin(), occurencies.end(), 0);
   double chi = 0; //istantaneous chi
