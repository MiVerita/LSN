...
double Random :: Lorentzian(double mu, double Gamma){
   //This function generates a random number from a Lorentzian distribution with given gamma parameter
   double y = Rannyu();
...
double Random :: Exponential(double lambda){
   //This function generated a random number from an exponential distribution with given decay constant
   double y = Rannyu();
